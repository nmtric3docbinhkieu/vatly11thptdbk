...
window.questionsChapter3 = [
    ...
    { 
        ...
        a: 0, 
        expl: "$F = k\\frac{|q_1q_2|}{r^2} = 9.10^9\\frac{|3.10^{-8}.(-4).10^{-8}|}{(0,04)^2} = 9.10^9\\frac{12.10^{-16}}{16.10^{-4}} = 6,75.10^{-3} N$" 
    },
    ...
    { 
        ...
        a: 1, 
        expl: "$E = k\\frac{|Q|}{r^2} = 9.10^9\\frac{5.10^{-8}}{(0,03)^2} = 9.10^9\\frac{5.10^{-8}}{9.10^{-4}} = 5.10^5 V/m$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$A = q.U = (-1,6.10^{-19}).120 = -1,92.10^{-17} J$. Dấu âm thể hiện lực điện cản trở chuyển động của electron." 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$Q = C.U = 30.10^{-6}.60 = 1800.10^{-6} = 1,8.10^{-3} C = 0,0018 C$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "Mắc song song: $C_b = C_1 + C_2 = 3 + 5 = 8 µF$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "Mắc nối tiếp: $\\frac{1}{C_b} = \\frac{1}{C_1} + \\frac{1}{C_2} = \\frac{1}{3} + \\frac{1}{6} = \\frac{1}{2} \\Rightarrow C_b = 2 µF$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$A = q.E.d = q.E.AB.\\cos\\alpha = 3.10^{-6}.6000.0,12.\\cos60° = 3.10^{-6}.6000.0,12.0,5 = 1,08.10^{-3} J$" 
    },
    ...
    { 
        ...
        a: 1, 
        expl: "Proton chuyển động như vật ném ngang: theo phương vuông góc với điện trường là chuyển động thẳng đều, theo phương song song với điện trường là chuyển động thẳng nhanh dần đều. Quỹ đạo là đường parabol." 
    },
    ...
    { 
        ...
        a: 3, 
        expl: "Năng lượng tụ điện $W = \\frac{1}{2}CU^2$. Khi U tăng 3 lần, W tăng $3^2 = 9$ lần." 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "Khi ngắt khỏi nguồn, Q không đổi. Nhúng vào điện môi, $C' = \\varepsilon C = 3C$. $U' = \\frac{Q}{C'} = \\frac{Q}{3C} = \\frac{U}{3}$." 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$F = k\\frac{q^2}{\\varepsilon r^2} \\Rightarrow q = r\\sqrt{\\frac{\\varepsilon F}{k}} = 0,04\\sqrt{\\frac{3.4,5.10^{-5}}{9.10^9}} = 0,04\\sqrt{\\frac{13,5.10^{-5}}{9.10^9}} = 0,04\\sqrt{1,5.10^{-14}} \\approx 8.10^{-9} C$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$F = k\\frac{q^2}{r^2} \\Rightarrow q = r\\sqrt{\\frac{F}{k}} = 0,05\\sqrt{\\frac{3,6.10^{-5}}{9.10^9}} = 0,05\\sqrt{4.10^{-15}} = 0,05.2.10^{-7,5} = 10^{-8} C$" 
    },
    ...
    { 
        ...
        a: 2, 
        expl: "$E_1 = k\\frac{|q_1|}{r^2} = 9.10^9\\frac{5.10^{-8}}{(0,04)^2} = 2,8125.10^5 V/m$. $E_2 = k\\frac{|q_2|}{r^2} = 9.10^9\\frac{5.10^{-8}}{(0,04)^2} = 2,8125.10^5 V/m$. Vì $q_1 > 0$ nên $\\vec{E_1}$ hướng ra xa A (từ M đến B), $q_2 < 0$ nên $\\vec{E_2}$ hướng về B (từ M đến B). Hai vectơ cùng hướng nên $E = E_1 + E_2 = 5,625.10^5 V/m$, hướng từ M đến B." 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$\\frac{1}{2}mv^2 = eU \\Rightarrow v = \\sqrt{\\frac{2eU}{m}} = \\sqrt{\\frac{2.1,6.10^{-19}.2000}{9,1.10^{-31}}} = \\sqrt{7,04.10^{14}} \\approx 2,65.10^7 m/s$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$Q = C.U = 30.10^{-12}.120 = 3,6.10^{-9} C$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$\\frac{1}{C_b} = \\frac{1}{C_1} + \\frac{1}{C_2} = \\frac{1}{3} + \\frac{1}{6} = \\frac{1}{2} \\Rightarrow C_b = 2 µF = 2.10^{-6} F$. $Q = C_b.U = 2.10^{-6}.120 = 2,4.10^{-4} C$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$U_{MN} = \\frac{A_{MN}}{q} = \\frac{3,2.10^{-4}}{8.10^{-6}} = 40 V$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$\\frac{1}{2}mv^2 = eU \\Rightarrow U = \\frac{mv^2}{2e} = \\frac{9,1.10^{-31}.(5.10^6)^2}{2.1,6.10^{-19}} = \\frac{9,1.10^{-31}.25.10^{12}}{3,2.10^{-19}} = \\frac{227,5.10^{-19}}{3,2.10^{-19}} = 71,1 V$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$W = \\frac{1}{2}CU^2 = \\frac{1}{2}.15.10^{-6}.200^2 = \\frac{1}{2}.15.10^{-6}.40000 = 7,5.10^{-6}.40000 = 0,3 J$" 
    },
    ...
    { 
        ...
        a: 2, 
        expl: "$\\frac{1}{C_b} = \\frac{1}{C} + \\frac{1}{C} + \\frac{1}{C} = \\frac{3}{C} \\Rightarrow C_b = \\frac{C}{3} = \\frac{3}{3} = 1 µF$" 
    },
    ...
    { 
        ...
        a: 3, 
        expl: "Mắc song song: $C_b = C + C + C = 3C = 3.3 = 9 µF$" 
    },
    ...
    { 
        ...
        a: 1, 
        expl: "Khi cân bằng, $\\tan\\alpha = \\frac{F}{P} = \\frac{r/2}{\\sqrt{l^2 - (r/2)^2}}$. Với $r = 0,08 m$, $l = 0,6 m$, $\\sqrt{l^2 - (r/2)^2} = \\sqrt{0,36 - (0,04)^2} = \\sqrt{0,36 - 0,0016} = \\sqrt{0,3584} \\approx 0,5987$. $\\tan\\alpha = \\frac{0,04}{0,5987} \\approx 0,0668$. $F = P\\tan\\alpha = 0,5.10^{-3}.10.0,0668 = 3,34.10^{-4} N$. $F = k\\frac{q^2}{r^2} \\Rightarrow q = r\\sqrt{\\frac{F}{k}} = 0,08\\sqrt{\\frac{3,34.10^{-4}}{9.10^9}} = 0,08\\sqrt{3,71.10^{-14}} = 0,08.1,93.10^{-7} \\approx 2,4.10^{-8} C$" 
    },
    ...
    { 
        ...
        a: 1, 
        expl: "$F_{13} = k\\frac{|q_1q_3|}{r^2} = 9.10^9\\frac{|3.10^{-8}.7.10^{-8}|}{0,08^2} = 9.10^9\\frac{21.10^{-16}}{64.10^{-4}} = 9.10^9.3,28.10^{-13} = 2,95.10^{-3} N$. $F_{23} = k\\frac{|q_2q_3|}{r^2} = 9.10^9\\frac{|(-5.10^{-8}).7.10^{-8}|}{0,08^2} = 9.10^9\\frac{35.10^{-16}}{64.10^{-4}} = 9.10^9.5,47.10^{-13} = 4,92.10^{-3} N$. Góc giữa $\\vec{F_{13}}$ và $\\vec{F_{23}}$ là 60° (do tam giác đều). $F = \\sqrt{F_{13}^2 + F_{23}^2 + 2F_{13}F_{23}\\cos60°} = \\sqrt{(2,95.10^{-3})^2 + (4,92.10^{-3})^2 + 2.2,95.10^{-3}.4,92.10^{-3}.0,5} = \\sqrt{8,70.10^{-6} + 24,2.10^{-6} + 14,5.10^{-6}} = \\sqrt{47,4.10^{-6}} = \\sqrt{47,4}.10^{-3} \\approx 6,88.10^{-3} N$" 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$E = \\frac{U}{d} = \\frac{300}{0,03} = 10^4 V/m$.<br>Gia tốc: $a = \\frac{eE}{m} = \\frac{1,6.10^{-19}.10^4}{9,1.10^{-31}} \\approx 1,76.10^{15} m/s^2$.<br>Thời gian chuyển động trong tụ: $t = \\frac{l}{v_0} = \\frac{0,06}{3.10^7} = 2.10^{-9} s$.<br>Độ lệch theo phương vuông góc (hướng về bản dương): $y = \\frac{1}{2}at^2 = \\frac{1}{2}.1,76.10^{15}.(2.10^{-9})^2 = 3,52.10^{-3} m = 0,352 cm$.<br>Electron bay vào từ sát bản âm (cách bản âm 0 cm), sau khi ra khỏi tụ nó đã lệch về phía bản dương một đoạn 0,352 cm.<br>Vậy khoảng cách từ electron đến bản dương lúc này là: $d - y = 3 - 0,352 = 2,648 cm$." 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "Khi ngắt khỏi nguồn, điện tích Q không đổi. $Q = C.U = 600.10^{-12}.400 = 2,4.10^{-7} C$. Khi nhúng vào điện môi, $C' = \\varepsilon C = 2,5.600 = 1500 pF = 1,5.10^{-9} F$. $U' = \\frac{Q}{C'} = \\frac{2,4.10^{-7}}{1,5.10^{-9}} = 160 V$." 
    },
    ...
    { 
        ...
        a: 0, 
        expl: "$C_{12} = \\frac{C_1C_2}{C_1 + C_2} = \\frac{2.3}{2+3} = \\frac{6}{5} = 1,2 µF$. $C_b = C_{12} + C_3 = 1,2 + 4 = 5,2 µF = 5,2.10^{-6} F$. $W = \\frac{1}{2}C_bU^2 = \\frac{1}{2}.5,2.10^{-6}.120^2 = \\frac{1}{2}.5,2.10^{-6}.14400 = 2,6.10^{-6}.14400 = 3,744.10^{-2} J$." 
    }
];